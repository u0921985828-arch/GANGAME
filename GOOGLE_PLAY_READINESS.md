...
(`ARTiFACTSFX404_v52.html`). Este informe evalúa qué falta para publicarla en Google Play
...
- [x] `MainActivity` + `WebViewAssetLoader` (origen seguro) cargando el HTML de `assets/` (v52 embebido)
