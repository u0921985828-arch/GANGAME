...
(`ARTiFACTSFX404_v47.html`). Este informe evalúa qué falta para publicarla en Google Play
...
- [x] `MainActivity` + `WebViewAssetLoader` (origen seguro) cargando el HTML de `assets/` (v47 embebido)
