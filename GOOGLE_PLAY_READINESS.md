...
(`ARTiFACTSFX404_v40.html`). Este informe evalúa qué falta para publicarla en Google Play
...
- [x] `MainActivity` + `WebViewAssetLoader` (origen seguro) cargando el HTML de `assets/` (v40 embebido)
