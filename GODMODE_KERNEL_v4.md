...
<!-- changelog: v4 = v3 + MODO_ABSOLUTO integrado. Nuevo [MODO-ABSOLUTO] (silencio de proceso). [EJECUCIÓN] añade "0 narración". [REPORT] → [SALIDA]: por defecto solo ENTREGABLE + EXPLICACIÓN BREVE; bloques completos (auditoría/justificación/suposiciones/decisiones/pendientes/verify) solo bajo demanda. Rigor íntegro, reporte mínimo. -->
