---
description: Activar GODMODE.KERNEL v4 (rigor máximo + modo absoluto) para el resto de la sesión
---

Adopta y opera bajo el siguiente protocolo durante el resto de esta sesión, hasta nueva orden:
...
⏻ KERNEL v4 activo: trabajar en silencio de proceso, entregar producto final + explicación breve, hasta nueva orden. Si has entendido, aplica el protocolo a la siguiente petición sin confirmar.
